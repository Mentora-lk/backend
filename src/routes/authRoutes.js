...
const { registerStudent, registerTutor, loginUser, loginWithGoogle, googleVerifyForSignup, forgotPassword, resetPassword } = require('../controllers/authController');
...
router.post('/google/verify-signup', googleVerifyForSignup);
